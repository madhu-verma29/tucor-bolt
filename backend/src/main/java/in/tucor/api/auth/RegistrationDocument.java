...
@Id public UUID id; @Column(name="user_id",nullable=false) public UUID userId; @Column(name="document_type",nullable=false) public String documentType; @Column(name="original_filename",nullable=false) public String originalFilename; @Column(name="stored_filename",nullable=false) public String storedFilename; @Column(name="content_type",nullable=false) public String contentType; @Column(name="size_bytes",nullable=false) public long sizeBytes; @Column(nullable=false) public String status="PENDING_REVIEW"; @Column(name="expires_at") public LocalDate expiresAt; @Column(name="rejection_reason") public String rejectionReason; @Column(name="created_at",nullable=false) public Instant createdAt;
